class Form {
    constructor() {
     ...
     this.greeting = createElement("h2");
      ...
      this.scorelabel=createElement('h2');
    ...
    this.playButton2.mousePressed(() => {
      ...
      if(this.answer1.value()==CorrectAnswer){
        ...
        */
        ...
        sound.play();
            ...
            this.question.html("Question:-What was the first country to use tanks in combat during World War I?" );
            this.question.position(150, 80);
      ...
      this.scorelabel.position(width/2+300,height/2);
